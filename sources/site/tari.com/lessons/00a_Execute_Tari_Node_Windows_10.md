...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/download-page.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/verify-hash.png)

In the address bar, type "cmd" (without quotes)

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/cmd.png)

This will open command prompt. Type in "sha256sum NameOfTariExe.exe" (without quotes). For example, if the Tari exe was called "tari\_base\_node-windows-0.2.1-ecfe782", you would type in "sha256sum tari\_base\_node-windows-0.2.1-ecfe782.exe" (without quotes).
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/hash-rate.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/install-1.png)

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/install-2.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/license-agreement.png)

Save the location of the Tari install for later

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/location-install.png)

You can have Tari create a start menu folder if you'd like, but we won't be using it for this tutorial.

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/start-menu.png)

You can have Tari create a desktop shortcut if you'd like, but we won't be using it for this tutorial.

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/desktop-shortcut.png)

Click install

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/ready-to-install.png)

Press Next

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/install-next.png)

Make sure all are clicked and press Finish

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/install-wizard.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/extra-dependency.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/configure-tari.png)

This will open a file explorer with a bunch of folders. The one we are looking for is called ".tari-testnet"

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/file-explorer.png)
...
![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/store-location.png)

Inside of the ".tari-testnet" folder, there is a folder called "config". Inside of that folder there is a file called "windows.toml". Open this file in your text editor of choice. Search for the text (data\_dir="rincewind") (without parenthesis). To save the blockchain on your D drive, place that text with this (data\_dir="d:\\tari\\rincewind") (without parenthesis). If you wish to use any other letter drive, replace the D with the letter you are using.

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/store-path.png)

### Mining Tari

You can skip this step if you don't plan on mining Tari.

Inside of the ".tari-testnet" folder, there is a folder called "config". Inside of that folder there is a file called "windows.toml". Open this file in your text editor of choice. Search for the text "num\_mining\_threads = 1" (without quotes). Change the 1 to however many threads you want your CPU to mine with. You can look up how many threads your CPU has if you want to mine with all of them. If you don't know what CPU you have press the window key and type "This PC" but instead of clicking on This PC, right-click it instead and click on properties

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/mine-tari.png)

![Downloads Lesson Graphic](https://tari.com/assets/lessons/img/processor.png)
