# Source: https://tari.com/user_agreement
...
> This is an agreement between Tari Labs, LLC ("Tari Labs", "we", "us", or "our") and you (together with Tari Labs, the "Parties" and each a "Party"). By using any Tari Labs service, whether through Tari Labs, any associated website, API, or desktop or mobile application, you agree that you have read, understood, and accept all of the terms and conditions contained herein (the "User Agreement"), as well as our Privacy Policy available at [www.tarilabs.com/privacy](http://www.tarilabs.com/privacy).
> 
...
2. Modification
 ...
 1. We may change the terms of this User Agreement at any time. Any such changes shall take effect when posted on the Tari Labs Site, or when you use the Services. If you have supplied us with an email address, we shall also attempt to notify you by email of changes to this User Agreement. If you disagree with any changes to this User Agreement, contact us.
...
> 
> **Tari Universe** means the open-source desktop application (located at [https://github.com/tari-project/universe](https://github.com/tari-project/universe)) which enables users to mine XTM, manage a non-custodial wallet, and interact with applications built on or integrated with the Tari Network. It is offered for personal, non-commercial use subject to a license agreement located at [https://github.com/tari-project/universe/blob/main/LICENSE.md](https://github.com/tari-project/universe/blob/main/LICENSE.md).
> 
...
4. Rights in Content Granted by Tari Labs
...
1. Description
 ...
 2. When you create a Wallet, the Wallet software generates a cryptographic private and public key pair that you may use to send and receive any XTM via the Tari Network. YOU MUST STORE, OUTSIDE OF THE SERVICES, A BACKUP OF ALL WALLET CREDENTIALS, INCLUDING YOUR EMOJI ID, PASSPHRASES, IDENTIFIERS, BACKUP PHRASES, PRIVATE KEYS AND NETWORK ADDRESSES. If you do not maintain a backup of your Wallet data outside of the Services, you will not be able to access XTM previously accessed using your Wallet in the event that we discontinue or no longer offer some or all of the Services or may otherwise lose access to XTM. We are not responsible for maintaining this data on your behalf.
...
2. Your Wallet
 ...
 1. As the owner of XTM in your Wallet, you shall bear all risk of loss of such XTM. Tari Labs shall not have any liability for fluctuations in the fiat currency value of XTM held in your Wallet.
...
3. Risk Disclosures Relating to Your Wallet
 ...
 2. Tari Labs has no control over the Tari Network and therefore cannot and does not ensure that any transaction details you submit via our Services will be confirmed on the Tari Network. The transaction details you submit via our Services may not be completed, or may be substantially delayed, by the Tari Network. We do not guarantee that the Wallet can transfer title or right in XTM or make any warranties whatsoever with regard to title.

 3. Once transaction details have been submitted to the Tari Network, we cannot assist you to cancel or otherwise modify your transaction or transaction details. Tari Labs has no control over the Tari Network and does not have the ability to facilitate any cancellation or modification requests.
...
7. Modification.
 ...
 > We may from time to time add, modify, or remove any feature, functionality, or usability of any tXTM.
...
4. Mining Pools
 ...
 1. Automatic Pool Participation

 > By using the Tari Universe application, you acknowledge and agree that your mining activity may be automatically included in a mining pool operated by a third party (a "Pool Operator"). Mining pools are mechanisms that aggregate the mining efforts of multiple participants to increase the likelihood of successfully mining new blocks. Rewards earned by the pool are then distributed proportionally among participants based on their contribution to the pool's mining activity.

 2. Pool Reward Distribution

 > Rewards generated by the mining pool will be automatically allocated to participants by the Pool Operator. The distribution of rewards is subject to the Pool Operator's rules and mechanisms, which may include minimum payout thresholds, time-based distribution schedules, and service fees.

 3. Minimum Balance and Distribution Deadlines

 > Pool Operators may require participants to reach a minimum XTM token balance in order to receive distributions. Additionally, Pool Operators may impose a deadline by which participants must achieve such a minimum balance. If the minimum balance is not reached by the specified deadline, the Pool Operator may retain or redistribute the participant's accrued rewards. Tari Labs does not control these policies and shall not be responsible for the enforcement or consequences of such rules.

 4. Pool Operator Fees

 > Pool Operators may charge participants a service fee for managing and operating the mining pool. Such fees may be deducted directly from a participant's share of mining rewards, and may be up to one percent (1%) of the rewards earned.

 5. No Liability of Tari Labs

 > You understand and agree that participation in any mining pool is at your own risk. Tari Labs is not a Pool Operator and does not manage or control the operation of any mining pool. Accordingly, you acknowledge and agree that Tari Labs shall have no liability whatsoever in connection with any mining pool or related activity. Further, you waive and release all claims against Tari Labs arising out of or relating to participation in any mining pool, including but not limited to claims related to unpaid, delayed, lost, forfeited, or incorrectly allocated mining rewards.

 6. Third Party Terms

 > Participation in a mining pool may be subject to separate terms and conditions imposed by the Pool Operator. You are solely responsible for reviewing and understanding any such terms. Tari Labs does not endorse or guarantee the performance or integrity of any Pool Operator.

 7. Changes and Termination

 > Pool participation rules, reward mechanics, fees, and distribution schedules are subject to change by the Pool Operator at any time. Tari Labs reserves the right to modify or discontinue support for mining pool functionality within the Tari Universe application at its sole discretion, without notice or liability.
...
> 
> d) XTM and tXTM are not legal tender and are not backed by any sovereign government. In addition, the legislative and regulatory landscape around virtual currencies such asXTM and tXTM is constantly changing and may affect your ability to use or transfer XTM and/or tXTM.
> 
...
1. Feedback
 ...
 1. Tari Labs strives to improve its Services to address feedback. If you have ideas or suggestions regarding improvements or additions to the Services, we would like to hear them; however, any submission shall be subject to this User Agreement.

 2. Under no circumstances shall disclosure of any idea or feedback, or any related material to Tari Labs be subject to any obligation of confidentiality or expectation of compensation.

 3. By submitting an idea or feedback or any related material that would be subject to intellectual property rights (the **Work**) to Tari Labs, you grant to Tari Labs, with respect to the Work submitted, a non-exclusive, perpetual, global, royalty-free license to use all of the content of such ideas and feedback, for any purpose whatsoever.

 4. By submitting Work, you are waiving any moral rights to the fullest extent permitted under law that you may have in the Work and are representing and warranting to Tari Labs that the Work originated with you, no one else has any rights in the Work, and that Tari Labs is free of any royalty to implement the Work and to use the related material if so desired, as provided or modified by Tari Labs, without obtaining permission or license from any third party.

 5. Tari Labs may sub-license in any way all Work and material you have submitted to Tari Labs.
...
2. Acceptable Use of Tari Labs Services
 ...
 6. Any and all of our indemnities, warranties, and limitations of liability (whether express or implied) are hereby excluded to the fullest extent permitted under law except as set forth herein. Nothing in this User Agreement excludes or limits liability which may not be limited or excluded under applicable law.
