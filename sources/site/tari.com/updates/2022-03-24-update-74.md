# Source: https://tari.com/updates/2022-03-24-update-74
...
[< Back to updates](https://tari.com/updates)![This week in Tari Development](https://tari.com/assets/updates/img/update-background.jpg)
...
The Tari base node exposes a number of metrics which can be used to create dashboards in [Grafana](https://grafana.com/) with [Prometheus](https://prometheus.io/).

To enable the metric, run the base node with the following:

`tari_base_node --metrics-bind-addr 127.0.0.1:1234`

Where `127.0.0.1:1234` is your [Prometheus](https://prometheus.io/) instance.
...
- **Sync:** ban peer if sending an invalid prev\_header ([#3955](https://github.com/tari-project/tari/issues/3955)) ([384ab0c](https://github.com/tari-project/tari/commit/384ab0ceddd25b5b31722fe639229c0ecf554926))
