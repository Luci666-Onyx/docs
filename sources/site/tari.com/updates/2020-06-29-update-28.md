# Source: https://tari.com/updates/2020-06-29-update-28
...
[< Back to updates](https://tari.com/updates)![Automating base node builds](https://tari.com/assets/updates/img/update-background.jpg)
...
(_Psst_: If you're a script wizard and develop on a Mac or Windows machine and want to contribute/improve the Github actions to fill these gaps, let us know!)
...
This is where the automated builds can help. Not only do automated builds save a ton of time, it's now also fairly simple to configure a bunch of builds for a range of architectures and CPUs! In fact, if you hop over to [https://tari.com/downloads](https://tari.com/downloads), you'll see a few new entries.
...
There are plans to refine the process and add even more architectures and supported chipsets in the future, but this is a great start. In particular, if you've been getting the `Illegal instruction` error on Linux, _please_ try and run the [x86\_64 safe version](https://tari-binaries.s3.amazonaws.com/linux/tari_base_node-ubuntu-x86-64-safe-0.4.2.bz2) and let us know if the problem goes away. The dev community really relies on the wider community to test this sort of thing.
