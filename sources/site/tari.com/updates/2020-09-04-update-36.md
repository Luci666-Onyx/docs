# Source: https://tari.com/updates/2020-09-04-update-36
...
[< Back to updates](https://tari.com/updates)![It's a monero block!](https://tari.com/assets/updates/img/update-background.jpg)

# It's a monero block!

September 4, 2020

![I ❤️ Hybrid](https://tari.com/assets/img/hybrid.jpg)
...
So cute! She weighed in a little light with a target difficulty of 2 and a height of [89446](https://explore.tari.com/block/89446), but the block and mother chain are healthy and doing great.

So now you can go ahead and earn testnet Tari _and_ testnet Monero if you so desire.

To start merge mining with Monero, you need to set up XMRig. There are some [instructions on how to do this in the Tari repo](https://github.com/tari-project/tari/tree/development/applications/tari_merge_mining_proxy). They could use a little love, so once you're up and running, why not [contribute a PR](https://github.com/tari-project/tari/edit/development/applications/tari_merge_mining_proxy/README.md) and improve them a little bit? Your fellow community members will love you for it, just as we all love little Blocky446.
