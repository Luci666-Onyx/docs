# Source: https://tari.com/updates/2023-04-13-update-106
...
[< Back to updates](https://tari.com/updates)![Tari is dead! Long live Tari!](https://tari.com/assets/updates/img/update-background.jpg)
...
A [recent post](https://tari.com/updates/2023-03-24-update-104.html) explained the two layer system in Tari. The two layers have had generic names for ages. The base layer/mimblewimble chain/Tari L1 is the proof-of-work layer that produces the native token, maintains a registry of L2 validator nodes, and acts as a version control system for L2 smart contract templates.
...
| Old name | New name | |------------------------------|----------------| | Tari L1 / Base layer | Minotari chain | | Tari token (XTR) | Minotari (XMT) | | Tari L2 / Second layer / DAN | Tari Network | | Tari L2 token (thaums) | Tari (XTR) |
