# Source: https://tari.com/updates/2023-01-20-update-98
...
[< Back to updates](https://tari.com/updates)![RFC documentation is up to date*](https://tari.com/assets/updates/img/update-background.jpg)
...
Over the course of time, almost all of our RFCs were marked `out-of-date`. Late last year, we, as the core contributor community set out to rectify that situation.

![Well, good news](https://tari.com/assets/img/posts/good_news.png)
...
Those RFCs are captured for posterity in the [Deprecated RFCs](https://rfc.tari.com/deprecated.html) chapter of the site. Again, like cleaning out the attic, you never end up throwing anything away.
...
- vanity\_id example should create id with base node features ([#5107](https://github.com/tari-project/tari/issues/5107)) ([3b21199](https://github.com/tari-project/tari/commit/3b21199dcf4639a7ca5cff727bcb49927b624842))
