# Source: https://tari.com/updates/2020-10-27-update-41
...
[< Back to updates](https://tari.com/updates)![Tari base node v0.6.0 released. New testnet Ridcully!](https://tari.com/assets/updates/img/update-background.jpg)
...
The current testnet Rincewind has reached its end. Ridcully will replace it starting with a new genesis block. If you have a previous base node, you should uninstall it first and do a clean install of v0.6.0. The install packages are available [on the downloads page](https://www.tari.com/downloads/).
...
- Add a client key-value store to the wallet and wallet\_ffi [PR](https://github.com/tari-project/tari/pull/2363)
