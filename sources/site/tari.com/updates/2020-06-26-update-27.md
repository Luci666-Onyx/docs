# Source: https://tari.com/updates/2020-06-26-update-27
...
[< Back to updates](https://tari.com/updates)![Tari Base node v0.4.2 release notes](https://tari.com/assets/updates/img/update-background.jpg)

# Tari Base node v0.4.2 release notes

June 26, 2020

🎉🎉🎉 Tari Base Node v0.4.2 is [available for download now](https://tari.com/downloads) 🍾🍾🍾
...
There's more detail on the emoji set changes in [a previous dev update](https://www.tari.com/updates/2020-06-10-update-23.html).

## gRPC support for base nodes

The base nodes now support gRPC. This will allow us to decouple the wallet and base node executables. To see the gRPC interface in action, you can peruse the [Block Explorer Source Code](https://github.com/tari-project/blockchain-explorer-api), which makes heavy use of gRPC.
...
The full release notes are on [GitHub](https://github.com/tari-project/tari/releases/tag/v0.4.2).
