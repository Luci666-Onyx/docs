# Source: https://tari.com/updates/2022-11-24-update-96
...
[< Back to updates](https://tari.com/updates)![Validator Node Registration](https://tari.com/assets/updates/img/update-background.jpg)

# Validator Node Registration

November 24, 2022

This week, draft [RFC-0313 - ValidatorNodeRegistration](https://rfc.tari.com/RFC-0313_VNRegistration.html) was merged and implemented for the igor network. This RFC describes the procedure for permissionless validator node registration and is the first step to participating in the Tari L2 network.
...
Each validator node registration is valid for up to `VNRegistrationValidityPeriod` epochs and a validator may re-register before the registration expires to ensure continued participation in L2 consensus.
...
6. Once the validator node registration has enough confirmations, your validator node is registered and ready to begin processing instructions as shown in [a previous post](https://tari.com/updates/2022-11-10-update-94.md).
