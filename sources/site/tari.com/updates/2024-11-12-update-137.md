# Source: https://tari.com/updates/2024-11-12-update-137
...
[< Back to updates](https://tari.com/updates)![Aurora Wallet Updates](https://tari.com/assets/updates/img/update-background.jpg)

# Aurora Wallet Updates
...
- Major fixes around transactions and how they reflect in the app, such as the balance not refreshing and the transaction history not being accurately reflected in the app. Giving the user better feedback regarding the Aurora app’s synchronization state with the blockchain.
...
- Efficiently closing unused RPC connections, preventing overloads, and optimizing wallet-to-node connectivity. ([PR #6649](https://github.com/tari-project/tari/pull/6649)) Updated build instructions for the Ledger Wallet on Nanosplus and Stax devices to ensure compatibility and smooth operation. ([PR #6673](https://github.com/tari-project/tari/pull/6673))
